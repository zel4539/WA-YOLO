...
class SAHIInference:
    """Runs Ultralytics YOLO11n and SAHI for object detection on video with options to view, save, and track results."""

    def __init__(self):
        """Initializes the SAHIInference class for performing sliced inference using SAHI with YOLO11n models."""
        self.detection_model = None

    def load_model(self, weights):
        """Loads a YOLO11n model with specified weights for object detection using SAHI."""
    ...
    def inference(
        ...
        """
        Run object detection on a video using YOLO11n and SAHI.
