---
comments: true
description: Learn how to use Ultralytics YOLO11n for real-time object blurring to enhance privacy and focus in your images and videos.
keywords: YOLO11n, object blurring, real-time processing, privacy protection, image manipulation, video editing, Ultralytics
---
...
while cap.isOpened():
    ...
    cv2.imshow("YOLO11n Blurring", im0)
    if cv2.waitKey(1) & 0xFF == ord("q"):
        break
