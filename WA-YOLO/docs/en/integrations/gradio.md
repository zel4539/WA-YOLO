---
comments: true
description: Discover an interactive way to perform object detection with Ultralytics YOLO11n using Gradio. Upload images and adjust settings for real-time results.
keywords: Ultralytics, YOLO11n, Gradio, object detection, interactive, real-time, image processing, AI
---
...
def predict_image(img, conf_threshold, iou_threshold):
    """Predicts objects in an image using a YOLO11n model with adjustable confidence and IOU thresholds."""
...
iface = gr.Interface(
    ...
    outputs=gr.Image(type="pil", label="Result"),
    title="Ultralytics Gradio YOLO11n",
    description="Upload images for YOLO11n object detection.",
)
iface.launch()
```
