---
comments: true
description: Explore the compact, versatile COCO8-Pose dataset for testing and debugging object detection models. Ideal for quick experiments with YOLO11n.
keywords: COCO8-Pose, Ultralytics, pose detection dataset, object detection, YOLO11n, machine learning, computer vision, training data
---
