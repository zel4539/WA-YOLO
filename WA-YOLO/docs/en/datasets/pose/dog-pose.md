---
comments: true
description: Discover the Dog-Pose dataset for pose detection. Featuring 6,773 training and 1,703 test images, it's a robust dataset for training YOLO11n models.
keywords: Dog-Pose, Ultralytics, pose detection dataset, YOLO11n, machine learning, computer vision, training data
---
