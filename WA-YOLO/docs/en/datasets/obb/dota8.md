---
comments: true
description: Explore the DOTA8 dataset - a small, versatile oriented object detection dataset ideal for testing and debugging object detection models using Ultralytics YOLO11n.
keywords: DOTA8 dataset, Ultralytics, YOLO11n, object detection, debugging, training models, oriented object detection, dataset YAML
---
