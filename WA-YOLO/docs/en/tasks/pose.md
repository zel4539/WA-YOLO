---
comments: true
description: Discover how to use YOLO11n for pose estimation tasks. Learn about model training, validation, prediction, and exporting in various formats.
keywords: pose estimation, YOLO11n, Ultralytics, keypoints, model training, image recognition, deep learning
