---
comments: true
description: Discover how to detect objects with rotation for higher precision using YOLO11n OBB models. Learn, train, validate, and export OBB models effortlessly.
keywords: Oriented Bounding Boxes, OBB, Object Detection, YOLO11n, Ultralytics, DOTAv1, Model Training, Model Export, AI, Machine Learning
