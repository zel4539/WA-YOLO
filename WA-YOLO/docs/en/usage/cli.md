---
comments: true
description: Explore the YOLO11n command line interface (CLI) for easy execution of detection tasks without needing a Python environment.
keywords: YOLO11n CLI, command line interface, YOLO11n commands, detection tasks, Ultralytics, model training, model prediction
---
